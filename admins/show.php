        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../admin/show.php">
...
<div class="container mt-5">
  <h3 class="alert alert-info mb-4">Data Admin</h3>
  
  <div class="card">
    
      <div class="card-body"> 
  <a href="create.php" class="btn btn-block btn-primary mb-4" style="color:white;">Tambah Admin</a>
                ...
                <?php $no=1 ; while($row = $result -> fetch_assoc()){ ?>
                          ...
                          <tr>
                              ...
                              <td>  
                                ...
                                <a href="edit.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary" style="color: white; float: right; margin: 10px;width: 100px;" >Edit</a>
                                <a onclick="return confirm(Apakah anda yakin?)" style="float: right; margin: 10px;width: 100px;" href="delete.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger alert_notif" style="color: white;">Hapus</a>
                            </td>

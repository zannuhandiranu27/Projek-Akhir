...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE berita SET judul ='$judul',kategori_id = '$kategori_id',isi = '$isi',isi2 = '$isi2',gambar = '$gambar' WHERE id_berita = $id;";
    ...
    <div class="post-content clearfix" style="font-size:17px;" >  
            ...
            <div class="card-body">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="judul" required value="<?php echo $judul ?>" >
                    </div>
                    <div class="mb-3 form-group">
                        <label for="kategori_id" class="form-label">kategori_id</label>
                        <input type="text" class="form-control" id="kategori_id" name="kategori_id" placeholder="kategori_id" required value="<?php echo $kategori_id ?>" >
                    </div>
                    <div class="mb-3 form-group">
                        <label for="isi" class="form-label">Paragraf 1</label>
                        <input type="text" class="form-control" id="isi" name="isi" placeholder="isi" required value="<?php echo $isi ?>" >
                    </div>
                    <div class="mb-3 form-group">
                        <label for="isi2" class="form-label">Paragraf 2</label>
                        <input type="text" class="form-control" id="isi2" name="isi2" placeholder="isi2" required value="<?php echo $isi2 ?>" >
                    </div>
                    <div class="mb-3 form-group">
                        <label for="gambar" class="form-label">gambar</label>
                        <input type="file" class="form-control" id="gambar" name="gambar" placeholder="gambar" required value="<?php echo $gambar ?>" >
                    </div>
